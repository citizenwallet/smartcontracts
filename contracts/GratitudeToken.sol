...
contract GratitudeToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function mintToMany(address[] memory recipients, uint256 amount) public onlyOwner {
    ...
    function mintToMany(address[] memory recipients, uint256[] memory amounts) public onlyOwner {
