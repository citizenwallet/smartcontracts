...
class TokenEntryPoint extends _i1.GeneratedContract {
  ...
  Future<bool> _isAddressInList(
    _i1.EthereumAddress addr,
    List<_i1.EthereumAddress> list, {
    _i1.BlockNum? atBlock,
  }) async {
    final function = self.abi.functions[1];
    assert(checkSignature(function, '70dc3611'));
    final params = [
      addr,
      list,
    ];
