...
class RedeemCodeFaucet extends _i1.GeneratedContract {
  ...
  Future<String> initialize(
    ...
    assert(checkSignature(function, 'bf2c2d1d'));
    final params = [
      _token,
      _redeemInterval,
      _codeCreator,
